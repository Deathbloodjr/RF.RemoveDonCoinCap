# RF.RemoveDonCoinCap
 A Rhythm Festival mod to remove the don coin cap.\
 This cap is visual only anyway, so now you can see how many coins you really have when you pass 99,999!
  
  <a href="https://shorturl.at/jdAR2"> <img src="Resources/InstallButton.png" alt="One-click Install using the Taiko Mod Manager" width="256"/> </a>
